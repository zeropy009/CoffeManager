...
BEGIN
    ...
    FROM  WAREHOUSE i
    WHERE EXISTS (SELECT 1 FROM inserted WHERE inserted.ID = i.ID)
       OR EXISTS (SELECT 1 FROM deleted WHERE deleted.ID = i.ID);
END;
GO
...
INSERT INTO [USER] 
([USER_NAME], [PASS_WORD], [ROLE_ID], [FULL_NAME], [SEX], [ADDRESS], [YEAR_OF_BIRTH], [PHONE], [EMAIL], [SALARY]) 
VALUES 
...
VALUES
(N'BLACK COFFEE', 14000, 1),
(N'FRESH MILK COFFEE', 18000, 1),
(N'EARL GREY MILK TEA', 22000, 2),
(N'CHOCOLATE MILK TEA', 20000, 2),
(N'ICE YOGURT', 25000, 3),
(N'STRAWBERRY YOGURT', 25000, 3),
(N'FRUIT YOGURT', 25000, 3),
(N'WATERMELON SMOOTHIE', 28000, 4),
(N'COCONUT SMOOTHIE', 28000, 4),
(N'ORANGE SMOOTHIE', 28000, 4),
(N'MATCHA HONEY', 30000, 5),
(N'MATCHA MANGO', 30000, 5),
(N'MATCHA OREO', 30000, 5),
(N'MATCHA RED BEAN', 30000, 5),
(N'STRAWBERRY ICE BLENDED', 30000, 6),
(N'RASPBERRY ICE BLENDED', 30000, 6),
(N'MINT SODA', 20000, 7),
(N'LEMON SODA', 20000, 7),
(N'BLACK TEA', 15000, 8),
(N'BUTTERFLY PEA TEA', 22000, 8),
(N'EARL GREY TEA', 25000, 8),
(N'OLONG TEA', 25000, 8),
(N'ORANGE JUICE', 26000, 9),
(N'APPLE JUICE', 23000, 9),
(N'WATERMELON JUICE', 19000, 9),
(N'STRAWBERRY JUICE', 20000, 9),
(N'PINEAPPLE JUICE', 20000, 9),
